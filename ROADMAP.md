...
- [~] Wave B2: S3 receptionist module [x] · S4 attribution module [x] · S5 run↔session linking [x] · W1 web auth [x] · W2 quest board [x] (commit with W3/W4) · W3 receptionist UI [x] (commit with W2/W4) · W4 settings/attribution UI + Vite CSP [~] (restarted 2026-09-26 after a usage-limit interruption)
